...
import { agentWsNamespace } from '../../../constants';
import { APP_WS_PORT } from '../../../config';

@WebSocketGateway({ port: APP_WS_PORT, namespace: agentWsNamespace })
export class OCampaignGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
